...
typedef enum lsio_transport_type_e {
	...
	LSIO_TRASNPORT_TYPE_XHR_POLLING = 1,
	LSIO_TRASNPORT_TYPE_XHR_MULTIPART = 2,
	LSIO_TRASNPORT_TYPE_HTMLFILE = 4,
	LSIO_TRASNPORT_TYPE_WEBSOCKET = 8,
	LSIO_TRASNPORT_TYPE_FLASHSOCKET = 16,
	LSIO_TRASNPORT_TYPE_JSONP_POLLING = 32
